      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            '提现审核：您提交的收款信息仅用于提现申请的审核与付款处理，仅限经授权的人员在必要范围内查看。',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            '提现：您需提交真实的收款人姓名、银行账号与开户行信息，提现申请须经平台审核。提现金额应达到应用内公示的起提额度，平台按公示费率收取手续费。审核通过后，款项将支付至您提交的收款账户，到账时间以实际处理为准。',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            'Withdrawal review. The payee details you submit are used only to review and pay out your withdrawal, and are visible only to authorized staff on a need-to-know basis.',
    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            'Balance. Your balance changes as you top up, send and receive transfers and red packets, and withdraw. The wallet features available to you are those offered in the app at the time. Balances do not earn interest.',
            ...
            'Withdrawals. You must supply an accurate payee name, bank account number, and branch. Every withdrawal request is reviewed. The amount must meet the published minimum, a fee is charged at the published rate, and once approved the funds are paid to the payee account you supplied. Arrival times depend on processing.',
